...
void reserve()
{
    ...
    else if(choice==16)
    {
        ...
        {
            printf("Reservation Confirmed :) :) :)\n");
            enQueue(AliceInTheWonderland,1);
            flag=0;
        }
        else printf("Book engaged @_@ @_@ @_@\n");
    }
